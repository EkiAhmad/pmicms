                ...
                <div class="card shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">Update Data Anamnesa Category</h6>
                                <h2 class="mb-0">Update Anamnesa Category</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route($route.'update_action') }}" class="form-global-handle" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="kategori_id" value="{{ Hashids::encode($data->kategori_id) }}">
                            <div class="form-group">
                                <label for="KategoriJudul">Category Judul</label>
                                <input type="text" name="kategori_judul" value="{{ $data->kategori_judul }}" class="form-control" id="KategoriJudul">
                            </div>
                            {{-- <div class="form-group">
