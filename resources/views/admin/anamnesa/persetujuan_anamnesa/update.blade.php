                ...
                <div class="card shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">Update Data Anamnesa Approval</h6>
                                <h2 class="mb-0">Update Anamnesa Approval</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route($route.'update_action') }}" class="form-global-handle" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="persetujuan_id" value="{{ Hashids::encode($data->persetujuan_id) }}">
                            <div class="form-group">
                                <label for="ApprovalContent">Approval Content</label>
                                <textarea name="persetujuan_content" class="form-control" id="ApprovalContent">{{ $data->persetujuan_content }}</textarea>
                            </div>
                            {{-- <div class="form-group">
