                ...
                <div class="card shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">Notify</h6>
                            ...
                            <table class="table align-items-center border" id="data-table">
                                <thead class="thead-light text-center">
                                    <tr>
                                        ...
                                        <th scope="col">Judul Notify</th>
                                        <th scope="col">Konten Notify</th>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            var url_ajax = '{!! route('admin.notify.getdata') !!}';
            var column = [
                        { data: 'no', name: 'no' },
                        { data: 'data_notify_judul', name: 'data_notify_judul' },
                        { data: 'data_notify_content', name: 'data_notify_content'},
                        { data: 'aksi', name: 'aksi' },
                    ];
