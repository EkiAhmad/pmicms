                ...
                <div class="card shadow">
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="text-uppercase text-muted ls-1 mb-1">Add Master Rumah Sakit</h6>
                                <h2 class="mb-0">Rumah Sakit</h2>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{ route($route.'create_action') }}" class="form-global-handle" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rs_name" class="form-control" id="RsName">
                            </div>
                            <div class="form-group">
                                <label for="RsDesc">Rumah Sakit Description</label>
                                <input type="text" name="rs_description" class="form-control" id="RsDesc">
                                {{-- <small>
                                    <div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rs_address" class="form-control" id="RsAddress">
                            </div>
                            <div class="group">
