                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route($route.'update_action') }}" class="form-global-handle" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="jenis_id" value="{{ Hashids::encode($data->jenis_id) }}">
                            <div class="form-group">
                                <label for="JenisName">Jenis Name</label>
                                <input type="text" name="jenis_name" value="{{ $data->jenis_name }}" class="form-control" id="JenisName">
                            </div>
                            <div class="form-group">
                                <label for="JenisDesc">Jenis Description</label>
                                <input type="text" name="jenis_description" class="form-control" id="JenisDesc" value="{{ $data->jenis_description }}">
                                {{-- <small>
                                    <div>
